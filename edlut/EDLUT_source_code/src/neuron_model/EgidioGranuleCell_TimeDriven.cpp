...
void EgidioGranuleCell_TimeDriven::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void EgidioGranuleCell_TimeDriven::LoadNeuronModel(){
...
void EgidioGranuleCell_TimeDriven::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
