...
void LIFTimeDrivenModel_1_2_NEW::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void LIFTimeDrivenModel_1_2_NEW::LoadNeuronModel(){
...
void LIFTimeDrivenModel_1_2_NEW::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
