...
void TimeDrivenPurkinjeCell::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void TimeDrivenPurkinjeCell::LoadNeuronModel(){
...
void TimeDrivenPurkinjeCell::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
