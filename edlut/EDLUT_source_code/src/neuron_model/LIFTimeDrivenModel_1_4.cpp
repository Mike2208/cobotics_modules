...
void LIFTimeDrivenModel_1_4::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void LIFTimeDrivenModel_1_4::LoadNeuronModel(){
...
void LIFTimeDrivenModel_1_4::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
