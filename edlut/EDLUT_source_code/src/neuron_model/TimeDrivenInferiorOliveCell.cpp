...
void TimeDrivenInferiorOliveCell::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void TimeDrivenInferiorOliveCell::LoadNeuronModel(){
...
void TimeDrivenInferiorOliveCell::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
