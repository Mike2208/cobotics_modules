...
void AdExTimeDrivenModel::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void AdExTimeDrivenModel::LoadNeuronModel(){
...
void AdExTimeDrivenModel::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
