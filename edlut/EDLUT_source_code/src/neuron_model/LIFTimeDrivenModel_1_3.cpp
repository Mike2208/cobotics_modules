...
void LIFTimeDrivenModel_1_3::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void LIFTimeDrivenModel_1_3::LoadNeuronModel(){
...
void LIFTimeDrivenModel_1_3::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
