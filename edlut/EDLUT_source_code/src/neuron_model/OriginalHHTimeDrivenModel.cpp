...
void OriginalHHTimeDrivenModel::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void OriginalHHTimeDrivenModel::LoadNeuronModel(){
...
void OriginalHHTimeDrivenModel::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
