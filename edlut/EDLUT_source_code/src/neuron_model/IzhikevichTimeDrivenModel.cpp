...
void IzhikevichTimeDrivenModel::LoadNeuronModel(string ConfigFile){
		FILE *fh;
	long Currentline = 0L;
...
void IzhikevichTimeDrivenModel::LoadNeuronModel(){
...
void IzhikevichTimeDrivenModel::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
