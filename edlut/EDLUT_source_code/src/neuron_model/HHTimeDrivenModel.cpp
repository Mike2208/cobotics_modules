...
void HHTimeDrivenModel::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void HHTimeDrivenModel::LoadNeuronModel(){
...
void HHTimeDrivenModel::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
