...
void LIFTimeDrivenModel_1_2::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void LIFTimeDrivenModel_1_2::LoadNeuronModel(){
...
void LIFTimeDrivenModel_1_2::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
