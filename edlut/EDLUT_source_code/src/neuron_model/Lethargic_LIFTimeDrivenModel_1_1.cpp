...
void Lethargic_LIFTimeDrivenModel_1_1::LoadNeuronModel(string ConfigFile){
	FILE *fh;
	long Currentline = 0L;
...
void Lethargic_LIFTimeDrivenModel_1_1::LoadNeuronModel(){
...
void Lethargic_LIFTimeDrivenModel_1_1::loadIntegrationMethod(string fileName, FILE *fh, long * Currentline){
