...
class LoadIntegrationMethod_GPU {
	...
	public:
		...
		static IntegrationMethod_GPU * loadIntegrationMethod_GPU(TimeDrivenNeuronModel_GPU* model, string fileName, FILE *fh, long * Currentline, int N_NeuronStateVariables, int N_DifferentialNeuronState, int N_TimeDependentNeuronState){
