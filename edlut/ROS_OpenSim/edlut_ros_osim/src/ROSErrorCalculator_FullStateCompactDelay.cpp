...
#include "edlut_ros_osim/ROSErrorCalculator_FullStateCompactDelay.h"
...
void ROSErrorCalculator_FullStateCompactDelay::FullStateCallback(const edlut_ros_osim::FullStateCompactDelay::ConstPtr& msg){
	...
	if (msg->header.stamp.toSec()<this->last_time){
		...
		edlut_ros_osim::FullStateCompactDelay newMessage;
				...
				last_time(0.0)
{
	...
	this->publisher = this->NodeHandler.advertise<edlut_ros_osim::AnalogCompactDelay>(output_topic_name, 1.0);
}
...
void ROSErrorCalculator_FullStateCompactDelay::UpdateError(ros::Time current_time){
	...
	edlut_ros_osim::AnalogCompactDelay newMsg;
...
void ROSErrorCalculator_FullStateCompactDelay::CleanQueue(std::priority_queue<edlut_ros_osim::FullStateCompactDelay, std::vector<edlut_ros_osim::FullStateCompactDelay>, analog_comparison > & queue,
	...
	edlut_ros_osim::FullStateCompactDelay top_value;
