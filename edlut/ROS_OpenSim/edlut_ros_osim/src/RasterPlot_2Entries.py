...
from edlut_ros_osim.cfg import DynParameters_2EntriesConfig
...
class RasterplotAnimation(matplotlib.animation.TimedAnimation):
	...
	def new_figure(self):
		...
		self.first_spike_subscriber = rospy.Subscriber(self.first_inputTopic, edlut_ros_osim.msg.Spike_group, self.FirstSpikeCallback, queue_size=None)
		self.second_spike_subscriber = rospy.Subscriber(self.second_inputTopic, edlut_ros_osim.msg.Spike_group, self.SecondSpikeCallback, queue_size=None)
	...
	def __init__(self):
		...
		# being showed.
		self.first_spike_subscriber = rospy.Subscriber(self.first_inputTopic, edlut_ros_osim.msg.Spike, self.FirstSpikeCallback, queue_size=None)
		self.first_spike_subscriber.unregister()

		self.second_spike_subscriber = rospy.Subscriber(self.second_inputTopic, edlut_ros_osim.msg.Spike, self.SecondSpikeCallback, queue_size=None)
		self.second_spike_subscriber.unregister()
