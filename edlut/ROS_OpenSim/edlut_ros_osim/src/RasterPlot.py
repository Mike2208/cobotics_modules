...
class RasterplotAnimation(matplotlib.animation.TimedAnimation):
	...
	def new_figure(self):
		...
		self.spike_subscriber = rospy.Subscriber(self.inputTopic, edlut_ros_osim.msg.Spike_group, self.SpikeCallback, queue_size=None)
	...
	def __init__(self):
		...
		# being showed.
		self.spike_subscriber = rospy.Subscriber(self.inputTopic, edlut_ros_osim.msg.Spike, self.SpikeCallback, queue_size=None)
		self.spike_subscriber.unregister()
