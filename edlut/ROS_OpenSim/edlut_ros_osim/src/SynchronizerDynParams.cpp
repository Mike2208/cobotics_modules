...
SynchronizerDynParams::SynchronizerDynParams(ros::NodeHandle *nh, ros::NodeHandle *pnh) : nh_(nh), pnh(pnh), dr_srv_(*pnh), paused(false), stop_ts(false), time_stamp(0.0) {
	dynamic_reconfigure::Server<edlut_ros_osim::SynchronizerDynParametersConfig>::CallbackType cb;
...
void SynchronizerDynParams::callback(edlut_ros_osim::SynchronizerDynParametersConfig &config, uint32_t level) {
