...
from edlut_ros_osim.cfg import DynParametersConfig
...
class RasterplotAnimation(matplotlib.animation.TimedAnimation):
	...
	def new_figure(self):
		...
		self.spike_subscriber = rospy.Subscriber(self.spike_inputTopic, edlut_ros_osim.msg.Spike_group, self.SpikeCallback, queue_size=None)
		self.analog_subscriber = rospy.Subscriber(self.analog_inputTopic, edlut_ros_osim.msg.AnalogCompactDelay, self.AnalogCallback, queue_size=None)
	...
	def __init__(self):
		...
		# being showed.
		self.spike_subscriber = rospy.Subscriber(self.spike_inputTopic, edlut_ros_osim.msg.Spike, self.SpikeCallback, queue_size=None)
		self.spike_subscriber.unregister()
