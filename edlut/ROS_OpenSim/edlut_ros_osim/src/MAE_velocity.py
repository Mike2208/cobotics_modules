...
from edlut_ros_osim.cfg import MaeDynParametersConfig
...
class MaeplotAnimation(matplotlib.animation.TimedAnimation):
	...
	def __init__(self):
		...
		rospy.Subscriber(self.full_stateTopic, edlut_ros_osim.msg.FullStateCompactDelay, self.FullStateCallback, queue_size=None)
