...
#include <edlut_ros_osim/SynchronizerDynParametersConfig.h>
 ...
 */
 ...
 private:
  ...
  dynamic_reconfigure::Server<edlut_ros_osim::SynchronizerDynParametersConfig> dr_srv_;
  //! ROS node handle.
  ros::NodeHandle *nh_;
  //! ROS node handle.
  ros::NodeHandle *pnh;
 public:
    ...
    *
    */
   void callback(edlut_ros_osim::SynchronizerDynParametersConfig &config, uint32_t level);
