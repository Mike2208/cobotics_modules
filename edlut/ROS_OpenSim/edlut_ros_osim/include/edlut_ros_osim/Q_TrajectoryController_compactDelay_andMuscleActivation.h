...
#ifndef Q_TRAJECTORYCONTROLLER_COMPACTDELAY_ANDMUSCLEACTIVATION_H_
#define Q_TRAJECTORYCONTROLLER_COMPACTDELAY_ANDMUSCLEACTIVATION_H_
 ...
 */
class Q_TrajectoryController_compactDelay_andMuscleActivation {
...
private:
	...
	// Muscle activation publisher
	ros::Publisher muscle_activation_pub;
...
public:
	 ...
	 */
	Q_TrajectoryController_compactDelay_andMuscleActivation(std::vector<std::string> joint_list,
			std::vector<std::string> muscle_list,
	 ...
	 */
	virtual ~Q_TrajectoryController_compactDelay_andMuscleActivation();
