...
public:
	bool operator() (const edlut_ros_osim::AnalogCompact lsp, const edlut_ros_osim::AnalogCompact rsp) const{
...
private:
	...
	std::priority_queue<edlut_ros_osim::AnalogCompact, std::vector<edlut_ros_osim::AnalogCompact>, analog_comparison > activity_queue_pos_plus;

	// Queue of actual position analog signals not processed yet
	std::priority_queue<edlut_ros_osim::AnalogCompact, std::vector<edlut_ros_osim::AnalogCompact>, analog_comparison > activity_queue_pos_minus;

	// Queue of desired velocity analog signals not processed yet
	std::priority_queue<edlut_ros_osim::AnalogCompact, std::vector<edlut_ros_osim::AnalogCompact>, analog_comparison > activity_queue_vel_plus;

	// Queue of actual velocity analog signals not processed yet
	std::priority_queue<edlut_ros_osim::AnalogCompact, std::vector<edlut_ros_osim::AnalogCompact>, analog_comparison > activity_queue_vel_minus;
	...
	void PositionPlusCallback(const edlut_ros_osim::AnalogCompact::ConstPtr& msg);

	// Callback function for reading input activity
	void VelocityPlusCallback(const edlut_ros_osim::AnalogCompact::ConstPtr& msg);

	// Callback function for reading input activity
	void PositionMinusCallback(const edlut_ros_osim::AnalogCompact::ConstPtr& msg);

	// Callback function for reading input activity
	void VelocityMinusCallback(const edlut_ros_osim::AnalogCompact::ConstPtr& msg);

	// Clean the input value queue and retrieve the last value
	void CleanQueue(std::priority_queue<edlut_ros_osim::AnalogCompact, std::vector<edlut_ros_osim::AnalogCompact>, analog_comparison > & queue,
