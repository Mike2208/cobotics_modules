...
public:
	bool operator() (const edlut_ros_osim::FullStateCompactDelay lsp, const edlut_ros_osim::FullStateCompactDelay rsp) const{
...
private:
	...
	std::priority_queue<edlut_ros_osim::FullStateCompactDelay, std::vector<edlut_ros_osim::FullStateCompactDelay>, analog_comparison > activity_queue;
	...
	void FullStateCallback(const edlut_ros_osim::FullStateCompactDelay::ConstPtr& msg);

	// Clean the input value queue and retrieve the last value
	void CleanQueue(std::priority_queue<edlut_ros_osim::FullStateCompactDelay, std::vector<edlut_ros_osim::FullStateCompactDelay>, analog_comparison > & queue,
			std::vector<double> & desired_position,
			std::vector<double> & desired_velocity,
			std::vector<double> & current_position,
			std::vector<double> & current_velocity,
