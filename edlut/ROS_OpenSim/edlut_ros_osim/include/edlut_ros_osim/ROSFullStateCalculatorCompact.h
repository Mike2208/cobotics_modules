...
public:
	bool operator() (const edlut_ros_osim::AnalogCompactDelay lsp, const edlut_ros_osim::AnalogCompactDelay rsp) const{
...
private:
	...
	std::priority_queue<edlut_ros_osim::AnalogCompactDelay, std::vector<edlut_ros_osim::AnalogCompactDelay>, analog_comparison > activity_queue_desired_pos;

	// Queue of actual position analog signals not processed yet
	std::priority_queue<edlut_ros_osim::AnalogCompactDelay, std::vector<edlut_ros_osim::AnalogCompactDelay>, analog_comparison > activity_queue_current_pos;

	// Queue of desired velocity analog signals not processed yet
	std::priority_queue<edlut_ros_osim::AnalogCompactDelay, std::vector<edlut_ros_osim::AnalogCompactDelay>, analog_comparison > activity_queue_desired_vel;

	// Queue of actual velocity analog signals not processed yet
	std::priority_queue<edlut_ros_osim::AnalogCompactDelay, std::vector<edlut_ros_osim::AnalogCompactDelay>, analog_comparison > activity_queue_current_vel;
	...
	void DesiredPositionCallback(const edlut_ros_osim::AnalogCompactDelay::ConstPtr& msg);

	// Callback function for reading input activity
	void DesiredVelocityCallback(const edlut_ros_osim::AnalogCompactDelay::ConstPtr& msg);

	// Callback function for reading input activity
	void CurrentPositionCallback(const edlut_ros_osim::AnalogCompactDelay::ConstPtr& msg);

	// Callback function for reading input activity
	void CurrentVelocityCallback(const edlut_ros_osim::AnalogCompactDelay::ConstPtr& msg);

	// Clean the input value queue and retrieve the last value
	void CleanQueue(std::priority_queue<edlut_ros_osim::AnalogCompactDelay, std::vector<edlut_ros_osim::AnalogCompactDelay>, analog_comparison > & queue,
