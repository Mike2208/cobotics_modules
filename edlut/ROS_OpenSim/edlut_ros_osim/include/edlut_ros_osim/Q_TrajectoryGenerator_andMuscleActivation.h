...
#ifndef Q_TRAJECTORYGENERATOR_ANDMUSCLEACTIVATION_H_
#define Q_TRAJECTORYGENERATOR_ANDMUSCLEACTIVATION_H_
 ...
 * \date September 2016
 */
class Q_TrajectoryGenerator_andMuscleActivation {
	...
	/*!
	 * Matrix containing muscle activations for the desired trajectory
	 */
	std::vector<std::vector<double> > Q_activations;
	...
	/*!
	 * File containing the muscle activations for the desired trajectory
	 */
	std::ifstream file_muscle_activation;
	 ...
	 *
	 */
	Q_TrajectoryGenerator_andMuscleActivation(bool sim_time,
			std::vector<double> max_pos_amplitude,
			std::vector<double> min_pos_amplitude,
			std::vector<double> max_vel_amplitude,
			std::vector<double> min_vel_amplitude,
			...
			double trajectory_frequency,
			std::vector<std::string> joint_list,
			std::string muscle_activation_file_name,
			std::vector<std::string> muscle_list);
	 ...
	 * Class desctructor.
	 */
	~Q_TrajectoryGenerator_andMuscleActivation();
	 ...
	 * This function provides the current position and velocity vectors according to the trajectory functions.
	 */
	void GetState(std::vector<double> & CurrentPosition, std::vector<double> & CurrentVelocity, std::vector<double> & CurrentActivation, double current_time);
